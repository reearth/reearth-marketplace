...
type User struct {
	...
	Description       *string           `json:"description"`
	Plugins           *PluginConnection `json:"plugins"`
	OrganinazationIds []string          `json:"organinazationIds"`
	Organinzations    []*Organization   `json:"organinzations"`
}
...
const (
	...
	PluginSortDonwloadsAsc    PluginSort = "DONWLOADS_ASC"
	PluginSortDonwloadsDesc   PluginSort = "DONWLOADS_DESC"
)
...
var AllPluginSort = []PluginSort{
	...
	PluginSortDonwloadsAsc,
	PluginSortDonwloadsDesc,
}

func (e PluginSort) IsValid() bool {
	switch e {
	case PluginSortNameAsc, PluginSortNameDesc, PluginSortPublisherAsc, PluginSortPublisherDesc, PluginSortPublishedatAsc, PluginSortPublishedatDesc, PluginSortDonwloadsAsc, PluginSortDonwloadsDesc:
		return true
	}
	return false
}
