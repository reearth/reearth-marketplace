...
type Plugin interface {
	FindByID(ctx context.Context, user *user.User, id id.PluginID) (*plugin.VersionedPlugin, error)
	FindByIDs(ctx context.Context, user *user.User, ids []id.PluginID) ([]*plugin.VersionedPlugin, error)
